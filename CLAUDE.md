...
**Phase 9b — the messaging overhaul — is in progress; M0 and M1 are done.** It
came off the first real beta feedback (no way to edit a message) and brings
...
anyone's messages (a report is the only window), and the app has an anchored
long-press menu with Copy/Edit/Delete/Report plus a 15-minute edit window. Full
